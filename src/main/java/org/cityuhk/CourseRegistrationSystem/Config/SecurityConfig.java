    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/timetable/**").hasAnyRole("STUDENT", "INSTRUCTOR")
                        .requestMatchers("/api/sections/**").hasAnyRole("ADMIN", "STUDENT", "INSTRUCTOR")
                        .requestMatchers("/api/studentlist/**").hasAnyRole("ADMIN", "INSTRUCTOR")
