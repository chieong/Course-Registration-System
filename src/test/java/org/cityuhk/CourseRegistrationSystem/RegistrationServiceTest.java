...
public class RegistrationServiceTest {
    ...
    void deleteStudentCallsDeleteByIdTest() {
        ...
        RegistrationService service = new RegistrationService(studentRepo, createStubSectionRepo(null),
                createStubRecordRepo(false, 0, false, false));

        service.deleteStudent(1);

        assertTrue(deleteByIdCalled[0], "Expected deleteById(...) to be called");
    }
}
